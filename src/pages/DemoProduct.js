...
const DemoProduct = (props) => {
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            <div className="flex">
                                <h1 className="font-bold text-center lg:text-left text-garmetGreen uppercase text-4xl">Demo our products</h1>
                            </div>
                        ...
                        <div className="my-2 w-1/2 lg:w-2/4">
                            <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-gray-500 hover:bg-garmetGreen text-gray-100 p-3 rounded-lg w-full 
                    ...
                    <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-garmetGreen rounded-2xl">
                        <div className="flex flex-col text-white">     
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="https://www.facebook.com/people/Soufiene-Garmet/pfbid0vtdBLYNmN4Uoa3xJsV6WbaToDJetWHCje7zDWj5HogvTTfH8MGM93KYu3pKsQic9l" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 mx-1 text-center pt-1">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className='fill-current font-black hover:animate-pulse'><circle cx="4.983" cy="5.009" r="2.188"></circle><path d="M9.237 8.855v12.139h3.769v-6.003c0-1.584.298-3.118 2.262-3.118 1.937 0 1.961 1.811 1.961 3.218v5.904H21v-6.657c0-3.27-.704-5.783-4.526-5.783-1.835 0-3.065 1.007-3.568 1.96h-.051v-1.66H9.237zm-6.142 0H6.87v12.139H3.095z"></path></svg>
                                 ...
                                 {/* Google Maps Icon */}
  <a
    href="https://www.google.com/maps/place/Etage+1+N°12,+Av+carthage+Ariana,+Tunisie,+2039"
    target="_blank"
    rel="noreferrer"
  ...
  >
    ...
    >
      <path d="M12 2C8.686 2 6 4.686 6 8c0 5.53 6 13 6 13s6-7.47 6-13c0-3.314-2.686-6-6-6zm0 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path>
    </svg>
  </a>
                            </div>
                        </div>
